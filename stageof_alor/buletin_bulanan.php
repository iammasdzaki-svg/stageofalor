...
<head>
    ...
    <title>Arsip Buletin Bulanan - Stasiun Geofisika Alor</title>
...
<body class="bg-gray-50 text-gray-800 font-sans">
    ...
    <header class="site-header hero-buletin border-b-4 border-yellow-500">
        <h2 class="site-title font-black uppercase tracking-tighter">Arsip Buletin Bulanan</h2>
    ...
    <main class="container mx-auto px-4 py-12">
        <div class="flex flex-col md:flex-row justify-between items-start gap-6 mb-10">
            <div class="border-l-8 border-blue-900 pl-6 w-full">
                <h3 class="text-3xl font-black text-gray-800 uppercase tracking-tighter">Daftar Buletin Bulanan</h3>
